...
- เร่งการทำ index ของไฟล์ `.txt`/`.md` ภาษาไทย โดยตัดคำหนึ่งครั้งต่อบรรทัดแทนการคำนวณซ้ำ
- อ่าน `.epub`, `.txt` และ `.md` ภาษาไทย พร้อมเมนูภาษาไทย
- Markdown รองรับ heading, ตัวหนา, ตัวเอียง, inline code, list, quote และ link text
- ใช้ค่าเดิมใน **Settings → Reader** สำหรับ line spacing และ paragraph alignment;
  โหมด Justified กระจายระยะเฉพาะขอบเขตคำไทย
